    ...
    <div className='_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16'>
      <div className='_feed_inner_timeline_content _padd_r24 _padd_l24'>
        ...
        <div className='_feed_inner_timeline_post_top'>
          <div className='_feed_inner_timeline_post_box'>
            <div className='_feed_inner_timeline_post_box_image'>
              <img src={post.author.image} alt={post.author.name} className='_post_img' />
            </div>
        ...
        {post.image && (
          <div className='_feed_inner_timeline_image'>
            <img src={post.image} alt='Post content' className='_time_img' />
          </div>
        )}
      </div>
      ...
      <div className='_feed_inner_timeline_total_reacts _padd_r24 _padd_l24 _mar_b26'>
        <div className='_feed_inner_timeline_total_reacts_image'>
          <img src='/images/react_img1.png' alt='Reaction' className='_react_img1' />
          <img src='/images/react_img2.png' alt='Reaction' className='_react_img' />
          <img
          ...
          <img
            ...
            className='_react_img _rect_img_mbl_none'
          />
          <p className='_feed_inner_timeline_total_reacts_para'>{post.reactions.count}+</p>
        </div>
          ...
          <form className='_feed_inner_comment_box_form' onSubmit={(e) => e.preventDefault()}>
            <div className='_feed_inner_comment_box_content'>
              <div className='_feed_inner_comment_box_content_image'>
                <img src='/images/comment_img.png' alt='Profile' className='_comment_img' />
              </div>
        ...
        <div className='_comment_main'>
          <div className='_comment_image'>
            <Link href='/profile' className='_comment_image_link'>
              <img src='/images/txt_img.png' alt='Profile' className='_comment_img1' />
            </Link>
          </div>
